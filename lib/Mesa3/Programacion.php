...
class Programacion extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $lenguetas->agregar('tareas', 'Tareas', $this->cargar_archivo('lib/Mesa3/Programacion.html'));
     // $lenguetas->agregar('staff',  'Staff',  $this->cargar_archivo('lib/Mesa3/ProgramacionStaff.html'));
        //
