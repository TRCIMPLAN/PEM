...
class CTEntornoUrbano extends \Base\Publicacion {
    ...
    //  $lenguetas->agregar('diagnostico', 'Diagnóstico', $this->cargar_archivo_markdown_extra('lib/Mesa3/CTEntornoUrbanoDiagnostico.md'));
    //  $lenguetas->agregar('resumen',     'Resumen',     $this->cargar_archivo_markdown_extra('lib/Mesa3/CTEntornoUrbanoResumen.md'));
