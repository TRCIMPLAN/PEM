...
class CTEntornoUrbano extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->encabezado    = '<img class="img-responsive encabezado-imagen" src="ct-entorno-urbano/encabezado.jpg">';
        ...
        $lenguetas->agregar('miembros',    'Miembros',    $this->cargar_archivo_markdown('lib/Mesa3/CTEntornoUrbanoMiembros.md'));
        $lenguetas->agregar('diagnostico', 'Diagnóstico', $this->cargar_archivo_markdown('lib/Mesa3/CTEntornoUrbanoDiagnostico.md'));
        $lenguetas->agregar('resumen',     'Resumen',     $this->cargar_archivo_markdown('lib/Mesa3/CTEntornoUrbanoResumen.md'));
        $lenguetas->agregar('multimedia',  'Multimedia',  $this->cargar_archivo_markdown('lib/Mesa3/CTEntornoUrbanoMultimedia.md'));
        //
