...
class CTMovilidadTransporte extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->encabezado    = '<img class="img-responsive encabezado-imagen" src="ct-movilidad-transporte/encabezado.jpg">';
        ...
        $lenguetas->agregar('miembros',     'Miembros',     $this->cargar_archivo_markdown_extra('lib/Mesa1/CTMovilidadTransporteMiembros.md'));
        $lenguetas->agregar('diagnostico',  'Diagnóstico',  $this->cargar_archivo_markdown_extra('lib/Mesa1/CTMovilidadTransporteDiagnostico.md'));
        $lenguetas->agregar('conclusiones', 'Conclusiones', $this->cargar_archivo_markdown('lib/Mesa1/CTMovilidadTransporteConclusiones.md'));
        $lenguetas->agregar('minuta',       'Minuta',       $this->cargar_archivo_markdown('lib/Mesa1/CTMovilidadTransporteMinuta.md'));
        $lenguetas->agregar('multimedia',   'Multimedia',   $this->cargar_archivo_markdown('lib/Mesa1/CTMovilidadTransporteMultimedia.md'));
        //
