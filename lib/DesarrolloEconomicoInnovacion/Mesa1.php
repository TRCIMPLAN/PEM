...
class Mesa1 extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre        = 'Desarrollo Económico e Innovación - Mesa 1';
     // $this->autor         = 'Autor';
     ...
     // $this->encabezado    = '<img class="img-responsive encabezado-imagen" src="mesa-1/encabezado.jpg">';
        ...
        $this->nombre_menu   = 'Desarrollo Económico > Mesa 1';
        //
        // Definir lenguetas
        //
        $lenguetas = new \Base\Lenguetas();
        $lenguetas->agregar('comite-tecnico',   'Comité Técnico',      $this->cargar_archivo_markdown('lib/DesarrolloEconomicoInnovacion/Mesa1ComiteTecnico.md'));
        ...
        $lenguetas->agregar('diagnostico',      'Diagnóstico',         $this->cargar_archivo_markdown('lib/DesarrolloEconomicoInnovacion/Mesa1Diagnostico.md'));
        $lenguetas->agregar('multimedia',       'Multimedia',          $this->cargar_archivo_markdown('lib/DesarrolloEconomicoInnovacion/Mesa1Multimedia.md'));
        //
